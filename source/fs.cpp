...
// 		if (R_FAILED(ret)) return ret;
		...
		sdmcArchive = (FS_Archive) { ARCHIVE_SDMC, fsMakePath(PATH_EMPTY, ""), *fsHandle };
...
// #endif
		...
		saveArchive = (FS_Archive) { ARCHIVE_SAVEDATA, fsMakePath(PATH_EMPTY, ""), *fsHandle };
